            ...
            <div id= "codes">
                ...
                <table width= "100%">
                    <tr>
                        ...
                        <td align= "right">
                          <asp:ImageButton ID="imgImportCsv" runat="server" ToolTip="<%# Resources.Messages.btn_import_csv_file %>" AlternateText="<%# Resources.Messages.btn_import_csv_file %>" ImageUrl="~/images/csvImport.png" onClientClick= "javascript: openP('importCsv',400); return false;"/> 
                        </td>
                    </tr>
                </table>
