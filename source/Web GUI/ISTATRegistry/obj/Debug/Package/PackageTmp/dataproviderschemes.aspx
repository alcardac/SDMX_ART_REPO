<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="dataproviderschemes.aspx.cs" Inherits="ISTATRegistry.dataproviderschemes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3 class="PageTitle"><%= Resources.Messages.lbl_data_provider_scheme %></h3>
    <hr style="width: 100%" />
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="" ShowHeader="False">
                        <ItemTemplate>
                            ...
                            ucArtefactType='DataProviderScheme' />
                        </ItemTemplate>
            ...
            <br /><br />
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDataProviderSchemeList" TypeName="ISTAT.EntityMapper.EntityMapper">
                <SelectParameters>
                    <asp:Parameter Name="sdmxObjects" Type="Object" />
                </SelectParameters>
            </asp:ObjectDataSource>

            <asp:Button ID="btnAdd" runat="server" onclick="btnAdd_Click" Text="<%# Resources.Messages.btn_new_dataproviderscheme%>" />
