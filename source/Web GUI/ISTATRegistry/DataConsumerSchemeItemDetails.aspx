<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="DataConsumerSchemeItemDetails.aspx.cs" Inherits="ISTATRegistry.dataconsumerschemeItemDetails" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= gvDataConsumerschemesItem.ClientID %> .pgr a").click(function (e) {
                window.onbeforeunload = null;
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblDataConsumerSchemeDetail" runat="server" CssClass="PageTitle"><%= Resources.Messages.lbl_data_consumer_scheme %>&#32;<%= Resources.Messages.lbl_item_dettail %></asp:Label>
    <div id="divBack">
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/dataconsumerschemes.aspx?m=y" ImageUrl="~/images/back.png"><%= Resources.Messages.lbl_back %></asp:HyperLink></div>
    ...
    <div id="tab-container" class='tab-container'>
                <ul class='etabs'>
                    ...
                    <li class='tab'><a href="#dataconsumers"><%= Resources.Messages.lbl_dataconsumers %></a></li>
                </ul>
                    ...
                    <div id="general">
                        <table class="tableForm">
                            <tr>
                                ...
                                <td width="45%">
                                    <asp:TextBox ID="txtDSDID" runat="server" Enabled="false" ValidationGroup="dsd" Text="DATACONSUMERS"></asp:TextBox>
...
--%>                                    </asp:Panel>
             ...
             <div id= "dataconsumers">
             <asp:Label ID="lblNumberOfTotalElements" runat="server" Text=""></asp:Label>
                     <asp:GridView ID="gvDataConsumerschemesItem" runat="server" width="730px"
            AllowPaging="True" 
            CssClass="Grid"
            onpageindexchanging="gvDataConsumerschemesItem_PageIndexChanging" 
            OnRowCommand = "gvDataConsumerschemesItem_RowCommand"
            AutoGenerateColumns="False" onrowupdating="gvDataConsumerschemesItem_RowUpdating" 
                     onrowdeleting="gvDataConsumerschemesItem_RowDeleting" 
                     onrowdatabound="gvDataConsumerschemesItem_RowDataBound">
        <Columns>
    ...
    <table width= "100%">
        <tr>
            <td align= "left">
                <asp:Button ID= "btnAddNewDataConsumer" text="<%# Resources.Messages.lbl_add_data_consumer%>" onClientClick= "javascript: openP('df-Dimension',600); return false;" runat="server" onclick="btnAddNewDataConsumer_Click" /> 
            </td>
            <td align= "right">
    ...
    <div id="df-Dimension" class="popup_block">
        ...
        <asp:Label ID="lbl_title_new" runat="server" Text="<%# Resources.Messages.lbl_add_data_consumer%>" CssClass="PageTitle"></asp:Label>
       ...
       <tr>
                <td colspan = "2">
                    <center>
                       ...
                       <asp:Button OnClick="btnAddNewDataConsumer_Click" ID="btnNewDataConsumer" runat="server" Text="<%# Resources.Messages.btn_add_data_consumer %>"/>
    ...
    <asp:Button ID="btnSaveMemoryDataConsumerScheme" runat="server" Text="<%# Resources.Messages.btn_save%>" onclick="btnSaveMemoryDataConsumerScheme_Click" /> 
    
    <div style="float:right"><uc1:FileDownload3 ID="FileDownload31" runat="server"/></div>

    <div id="df-Dimension-update" class="popup_block">
        <asp:Label ID="lbl_title_update" runat="server" Text="<%# Resources.Messages.lbl_update_data_consumer%>" CssClass="PageTitle"></asp:Label>
        ...
        <tr>
            <td colspan = "2">
                <center>
                    ...
                    <asp:Button OnClick="btnUpdateDataConsumer_Click" ID="btnUpdateDataConsumer" runat="server" Text="<%# Resources.Messages.btn_update_data_consumer %>"/>
    ...
    <div id="data_consumer_annotation" class="popup_block">
    <asp:Label ID="lblAnnotationAttribute" runat="server" Text="Annotation Manager" CssClass="PageTitle"></asp:Label>
        <hr style="width: 95%;" />
        <table class="tableForm">
            <tr>
                <td>
                    <uc4:ControlAnnotations ID="ctr_annotation_update" runat="server" PopUpContainer="data_consumer_annotation" />
                </td>
            </tr>
        </table>             
        <asp:Button ID="btnSaveAnnotationCode" runat="server" Text="<%# Resources.Messages.btn_save %>" onclick="btnSaveAnnotationDataConsumer_Click" /> 
    </div>
