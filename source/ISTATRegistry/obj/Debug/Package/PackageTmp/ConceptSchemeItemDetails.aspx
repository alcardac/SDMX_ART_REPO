<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="ConceptSchemeItemDetails.aspx.cs" Inherits="ISTATRegistry.conceptschemeItemDetails" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= gvConceptschemesItem.ClientID %> .pgr a").click(function (e) {
                window.onbeforeunload = null;
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblConceptSchemeDetail" runat="server" CssClass="PageTitle"><%= Resources.Messages.lbl_concept_scheme %>&#32;<%= Resources.Messages.lbl_item_dettail %></asp:Label>
    <div id="divBack">
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/conceptschemes.aspx?m=y" ImageUrl="~/images/back.png"><%= Resources.Messages.lbl_back %></asp:HyperLink></div>
    ...
    <div id="tab-container" class='tab-container'>
                <ul class='etabs'>
                    ...
                    <li class='tab'><a href="#concepts"><%= Resources.Messages.lbl_concepts %></a></li>
                </ul>
...
--%>                                    </asp:Panel>
             ...
             <asp:GridView ID="gvConceptschemesItem" runat="server" width="730px"
            AllowPaging="True" 
            CssClass="Grid"
            onpageindexchanging="gvConceptschemesItem_PageIndexChanging" 
            OnRowCommand = "gvConceptschemesItem_RowCommand"
            AutoGenerateColumns="False" onrowupdating="gvConceptschemesItem_RowUpdating" 
                     onrowdeleting="gvConceptschemesItem_RowDeleting" 
                     onrowdatabound="gvConceptschemesItem_RowDataBound">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Parent Code" SortExpression="ParentCode">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("ParentCode") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
    ...
    <table width= "100%">
        <tr>
            <td align= "left">
                <asp:Button ID= "btnAddNewConcept" text="<%# Resources.Messages.lbl_add_concept%>" onClientClick= "javascript: openP('df-Dimension',600); return false;" runat="server" onclick="btnAddNewConcept_Click" /> 
            </td>
            <td align= "right">
    ...
    <div id="df-Dimension" class="popup_block">
        ...
        <asp:Label ID="lbl_title_new" runat="server" Text="<%# Resources.Messages.lbl_add_concept%>" CssClass="PageTitle"></asp:Label>
       ...
       <tr>
        <td>
         <asp:Label ID="lbl_parentid_new" runat="server" Text="<%# Resources.Messages.lbl_parent_concept + ':' %>" CssClass="tdProperty"></asp:Label>
        </td>
        <td>
            ...
            <tr>
                <td colspan = "2">
                    <center>
                       ...
                       <asp:Button OnClick="btnAddNewConcept_Click" ID="btnNewConcept" runat="server" Text="<%# Resources.Messages.btn_add_concept %>"/>
    ...
    <asp:Button ID="btnSaveMemoryConceptScheme" runat="server" Text="<%# Resources.Messages.btn_save%>" onclick="btnSaveMemoryConceptScheme_Click" /> 
    
    <div style="float:right"><uc1:FileDownload3 ID="FileDownload31" runat="server"/></div>

    <div id="df-Dimension-update" class="popup_block">
        <asp:Label ID="lbl_title_update" runat="server" Text="<%# Resources.Messages.lbl_update_concept%>" CssClass="PageTitle"></asp:Label>
        ...
        <tr>
        <td>
            <asp:Label ID="lbl_parentid_update" runat="server" Text="<%# Resources.Messages.lbl_parent_concept + ':' %>" CssClass="tdProperty"></asp:Label>
        </td>
        <td>
        ...
        <tr>
            <td colspan = "2">
                <center>
                    ...
                    <asp:Button OnClick="btnUpdateConcept_Click" ID="btnUpdateConcept" runat="server" Text="<%# Resources.Messages.btn_update_concept %>"/>
    ...
    <div id="concept_annotation" class="popup_block">
    <asp:Label ID="lblAnnotationAttribute" runat="server" Text="Annotation Manager" CssClass="PageTitle"></asp:Label>
        <hr style="width: 95%;" />
        <table class="tableForm">
            <tr>
                <td>
                    <uc4:ControlAnnotations ID="ctr_annotation_update" runat="server" PopUpContainer="concept_annotation" />
                </td>
            </tr>
        </table>
        <asp:Button ID="btnSaveAnnotationCode" runat="server" Text="<%# Resources.Messages.btn_save %>" onclick="btnSaveAnnotationConcept_Click" /> 
    </div>
