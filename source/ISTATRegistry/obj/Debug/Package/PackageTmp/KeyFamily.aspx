<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="KeyFamily.aspx.cs" Inherits="ISTATRegistry.keyFamily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 class="PageTitle"><%= Resources.Messages.lbl_key_family %></h3>
    ...
    <iup:IstatUpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br /><br />
            <asp:Button ID="btnAdd" runat="server" onclick="btnAdd_Click" Text="<%# Resources.Messages.btn_new_keyFamily %>" />
        </ContentTemplate>
