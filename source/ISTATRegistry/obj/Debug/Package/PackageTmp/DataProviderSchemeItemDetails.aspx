<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="DataProviderSchemeItemDetails.aspx.cs" Inherits="ISTATRegistry.dataproviderschemeItemDetails" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%= gvDataProviderschemesItem.ClientID %> .pgr a").click(function (e) {
                window.onbeforeunload = null;
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblDataProviderSchemeDetail" runat="server" CssClass="PageTitle"><%= Resources.Messages.lbl_data_provider_scheme %>&#32;<%= Resources.Messages.lbl_item_dettail %></asp:Label>
    <div id="divBack">
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/dataproviderschemes.aspx?m=y" ImageUrl="~/images/back.png"><%= Resources.Messages.lbl_back %></asp:HyperLink></div>
    ...
    <div id="tab-container" class='tab-container'>
                <ul class='etabs'>
                    ...
                    <li class='tab'><a href="#dataproviders"><%= Resources.Messages.lbl_dataproviders %></a></li>
                </ul>
                    ...
                    <div id="general">
                        <table class="tableForm">
                            <tr>
                                ...
                                <td width="45%">
                                    <asp:TextBox ID="txtDSDID" runat="server" Enabled="false" ValidationGroup="dsd" Text="DATAPROVIDERS"></asp:TextBox>
...
--%>                                    </asp:Panel>
             ...
             <asp:Label ID="lblNumberOfTotalElements" runat="server" Text=""></asp:Label> 
                     <asp:GridView ID="gvDataProviderschemesItem" runat="server" width="730px"
            AllowPaging="True" 
            CssClass="Grid"
            onpageindexchanging="gvDataProviderschemesItem_PageIndexChanging" 
            OnRowCommand = "gvDataProviderschemesItem_RowCommand"
            AutoGenerateColumns="False" onrowupdating="gvDataProviderschemesItem_RowUpdating" 
                     onrowdeleting="gvDataProviderschemesItem_RowDeleting" 
                     onrowdatabound="gvDataProviderschemesItem_RowDataBound">
        <Columns>
    ...
    <table width= "100%">
        <tr>
            <td align= "left">
                <asp:Button ID= "btnAddNewDataProvider" text="<%# Resources.Messages.lbl_add_data_provider%>" onClientClick= "javascript: openP('df-Dimension',600); return false;" runat="server" onclick="btnAddNewDataProvider_Click" /> 
            </td>
            <td align= "right">
    ...
    <div id="df-Dimension" class="popup_block">
        ...
        <asp:Label ID="lbl_title_new" runat="server" Text="<%# Resources.Messages.lbl_add_data_provider%>" CssClass="PageTitle"></asp:Label>
       ...
       <tr>
                <td colspan = "2">
                    <center>
                       ...
                       <asp:Button OnClick="btnAddNewDataProvider_Click" ID="btnNewDataProvider" runat="server" Text="<%# Resources.Messages.btn_add_data_provider %>"/>
    ...
    <asp:Button ID="btnSaveMemoryDataProviderScheme" runat="server" Text="<%# Resources.Messages.btn_save%>" onclick="btnSaveMemoryDataProviderScheme_Click" /> 
    
    <div style="float:right"><uc1:FileDownload3 ID="FileDownload31" runat="server"/></div>

    <div id="df-Dimension-update" class="popup_block">
        <asp:Label ID="lbl_title_update" runat="server" Text="<%# Resources.Messages.lbl_update_data_provider%>" CssClass="PageTitle"></asp:Label>
        ...
        <tr>
            <td colspan = "2">
                <center>
                    ...
                    <asp:Button OnClick="btnUpdateDataProvider_Click" ID="btnUpdateDataProvider" runat="server" Text="<%# Resources.Messages.btn_update_data_provider %>"/>
    ...
    <div id="data_provider_annotation" class="popup_block">
    <asp:Label ID="lblAnnotationAttribute" runat="server" Text="Annotation Manager" CssClass="PageTitle"></asp:Label>
        <hr style="width: 95%;" />
        <table class="tableForm">
            <tr>
                <td>
                   <uc4:ControlAnnotations ID="ctr_annotation_update" runat="server" PopUpContainer="data_provider_annotation" />
                </td>
            </tr>
        </table>        
        <asp:Button ID="btnSaveAnnotationCode" runat="server" Text="<%# Resources.Messages.btn_save %>" onclick="btnSaveAnnotationDataProvider_Click" /> 
    </div>
