<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="organizationunitschemes.aspx.cs" Inherits="ISTATRegistry.organizationunitschemes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3 class="PageTitle"><%= Resources.Messages.lbl_organization_unit_scheme %></h3>
    <hr style="width: 100%" />
    <iup:IstatUpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="" ShowHeader="False">
                        <ItemTemplate>
                            ...
                            ucArtefactType='OrganizationUnitScheme' />
                        </ItemTemplate>
            ...
            <br /><br />
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetOrganizationUnitSchemeList" TypeName="ISTAT.EntityMapper.EntityMapper">
                <SelectParameters>
                    <asp:Parameter Name="sdmxObjects" Type="Object" />
                </SelectParameters>
            </asp:ObjectDataSource>

            <asp:Button ID="btnAdd" runat="server" onclick="btnAdd_Click" Text="<%# Resources.Messages.btn_new_organizationunitscheme%>" />
